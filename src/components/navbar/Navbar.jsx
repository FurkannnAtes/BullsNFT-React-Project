            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark mainNavbar">
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="MainNavSubContent">
                        ...
                        <a href="https://discord.gg/VxkC8zmbWP" target="_blank" className="custon-buttom d-inline-block">
                            <div style={{ color: " #B24BF3" }} className="custom-button-text">JOIN DISCORD</div>
